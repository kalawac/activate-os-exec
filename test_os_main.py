def main():
    print("I'm running the test_os_main file")
    return
...
#     # The hook may have to actually deal with the activator so that it can activate 
#     # with the correct args and then pass that into main
